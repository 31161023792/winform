...
namespace UI
{
    public partial class frm_MainForm : Form
    {
        ...
        private void giớiThiệuToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Chung Hoàng Khánh \nLê Thành Đạt \nNguyễn Xuân Ngọc \nNguyễn Hoàng Nam", "Phần mềm được viết bởi",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        ...
        private void báoCáoHàngHóaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            reportHangHoa rphh = new reportHangHoa();
            rphh.MdiParent = this;
            rphh.StartPosition = FormStartPosition.CenterScreen;
            rphh.WindowState = FormWindowState.Maximized;
            rphh.Show();
        }

        private void báoCáoPhiếuNhậpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Report rppn = new Report();
            rppn.MdiParent = this;
            rppn.StartPosition = FormStartPosition.CenterScreen;
            rppn.WindowState = FormWindowState.Maximized;
            rppn.Show();
        }
    }
}
