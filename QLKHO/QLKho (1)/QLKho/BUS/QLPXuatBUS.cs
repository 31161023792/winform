...
namespace BUS
{
    public class QLPXuatBUS
    {
        ...
        {
            data.DataSource = QLPXuatDAL.Instance.timkiemhet();
            data.Columns[0].HeaderText = "Mã Phiếu Xuất";
            data.Columns[1].HeaderText = "Mã Đơn Hàng";
            data.Columns[2].HeaderText = "Tên Nhân Viên";
            data.Columns[3].HeaderText = "Thời gian";
        }
    }
}
